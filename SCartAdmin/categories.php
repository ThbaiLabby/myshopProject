    ...
    <div id="content">
        <?PHP
            if(isset($_SESSION['adminlogin'])){
                ...
                $tblCategories = new ajaxCRUD("Categoties", "categories", "id");

                // display headers as reasonable titles
                $tblCategories->displayAs("id", "Category Number");
                $tblCategories->displayAs("category", "Category");

                // show to the table
                $tblCategories->showTable();
            }  else {
                //display login form
                ?>
                <form method="POST">
