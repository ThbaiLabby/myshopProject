    ...
    <div id="content">
        <?PHP
            if(isset($_SESSION['adminlogin'])){
                ...
                $tblUsers->displayAs("id", "User ID");
                $tblUsers->displayAs("Firsname", "Firstname");
                $tblUsers->displayAs("Surname", "Surname");
                $tblUsers->displayAs("Email", "Email");
                $tblUsers->displayAs("Phone", "Phone");

                // add the filter box (above the table)
                $tblUsers->addAjaxFilterBox("Firstname");
